...
files = [
    ...
    "logs/log1125_141628.txt",
    "logs/log1125_150142.txt",
    "logs/log1125_171329.txt"
]
...
labels = [
    ...
    "lr 5e-6, prompt learning - roberta-large-wwm",
    "lr 5e-6, prompt learning - xlm-roberta-large",
    "lr 6e-6, prompt learning clean_stop_"
]
